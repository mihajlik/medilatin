...
% Ezek szerint tudok már beleírni - kérdés, jó-e itt...
% Alternative title:
%\title{Unified Simplified Grapheme Acoustic Modeling for LVCSR of Medieval Latin} % 1. alternatíva
%\title{Language Specific Data Free Acoustic Modeling for LVCSR of Medieval Latin} % 2. alternatíva - preferred so far by MP
